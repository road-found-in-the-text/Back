...
public class AssessmentQuestionScoreServiceTest {
    ...
    private Script init(){
        ...
        AssessmentQuestion assessmentQuestion1 = new AssessmentQuestion(1L,1,0,"분석력");
        AssessmentQuestion assessmentQuestion1_1 = new AssessmentQuestion(2L,1,1,"분석력이 좋은가?");
        AssessmentQuestion assessmentQuestion1_2 = new AssessmentQuestion(3L,1,2,"분석력이 나쁜가?");
        AssessmentQuestion assessmentQuestion1_3 = new AssessmentQuestion(4L,1,3,"분석력이 좋은 사람인가?");

        AssessmentQuestion assessmentQuestion2 = new AssessmentQuestion(5L,2,0,"이해력");
        AssessmentQuestion assessmentQuestion2_1 = new AssessmentQuestion(6L,2,1,"이해력 좋은가?");
        AssessmentQuestion assessmentQuestion2_2 = new AssessmentQuestion(7L,2,2,"이해력 나쁜가?");
        AssessmentQuestion assessmentQuestion2_3 = new AssessmentQuestion(8L,2,3,"이해력 좋은 사람인가?");

        AssessmentQuestion assessmentQuestion3 = new AssessmentQuestion(9L,3,0,"판단력");
        AssessmentQuestion assessmentQuestion3_1 = new AssessmentQuestion(10L,3,1,"판단력 좋은가?");
        AssessmentQuestion assessmentQuestion3_2 = new AssessmentQuestion(11L,3,2,"판단력 나쁜가?");
